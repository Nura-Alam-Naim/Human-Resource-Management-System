      ...
      <div className="departments-grid">
        {departments.length === 0 ? (
          ...
          departments.map(dept => (
            ...
            >
              {(dept.pending_transfers > 0 || dept.pending_member_requests > 0) && (
                <div className="absolute -top-2 -right-2 bg-red-500 text-white w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold shadow-md" title="Pending requests">
                  {(dept.pending_transfers || 0) + (dept.pending_member_requests || 0)}
                </div>
              )}
